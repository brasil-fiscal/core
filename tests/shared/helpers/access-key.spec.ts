...
import { generateAccessKey, generateNumericCode } from '@core/shared/helpers/access-key';
...
describe('Chave de Acesso', () => {
  describe('generateAccessKey', () => {
    ...
    it('deve funcionar com modelo 57 (CTe)', () => {
      const key = generateAccessKey({
        uf: '51',
        dataEmissao: new Date('2026-04-28'),
        cnpj: '11222333000181',
      ...
      assert.strictEqual(key.length, 44);
      assert.strictEqual(key.substring(20, 22), '57');
    });
  });
